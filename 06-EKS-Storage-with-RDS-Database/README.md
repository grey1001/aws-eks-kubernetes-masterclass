...
kubectl run -it --rm --image=mysql:5.7 --restart=Never mysql-client -- mysql -h usermgmtdb.cluster-cw9pdiryciie.eu-west-3.rds.amazonaws.com -u admin -pdbpassword11

Note: the second option here is for aurora mysql
